...
* 正常流程：
  ...
  3. 用户选择预定某个类型的房间
  4. 系统跳转至对应的预定酒店信息表单
  5. 用户输入入住人姓名、手机号、房间数、入住人数以及有无儿童
  6. 系统根据用户填写的预定信息提供可选的优惠策略供用户选择
  7. 用户选择一个合适的优惠策略（只能一个）
...
* 扩展流程：
  ...
  * 6a. 若用户的订单没有对应的优惠券
      7. 系统不展示优惠策略，用户不用选择优惠券
  * 10a. 若用户的信用值小于等于0，那么系统阻止预定，并提示用户    
* 特殊需求：无
...
* 正常流程：
  ...
  3. 酒店工作人员填写新的酒店信息，包括商圈、地址、简介、星级和联系电话，填写完后提交
  4. 系统验证信息并保存更新后的酒店信息
* 扩展流程：
...
* 扩展流程：
  * 2a.酒店工作人员点击优惠策略后的”删除优惠劵“按钮
    * 1. 系统将优惠策略取消
  * 3a.如果是满减优惠券，填写的减免金额大于达标金额，系统会发出警告，要求酒店工作人员重新输入减免金额
...
![预定酒店-系统顺序图](https://colarhua-pic.oss-cn-shenzhen.aliyuncs.com/software-engineering/用户预订酒店-系统顺序图.png)
...
![搜索酒店-系统顺序图](https://colarhua-pic.oss-cn-shenzhen.aliyuncs.com/software-engineering/搜索酒店-系统顺序图.png)
