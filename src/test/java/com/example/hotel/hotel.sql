...
VALUES (1, '汉庭酒店', '欢迎您入住', '南京市栖霞区珠江路268号', 'XiDan', 'Three', 1829373819, 0, 5, 5, 5, 5, 5, NULL),
       ...
       /*
        (4, '格林豪泰', '欢迎您入住', '南京市栖霞区珠江路268号', 'XiDan', 'Four', 1829553719, 0, 5, 5, 5, 5, 5, NULL),
        (5, '布丁酒店', '欢迎您入住', '南京市栖霞区珠江路268号', 'XiDan', 'Four', 1829553719, 0, 5, 5, 5, 5, 5, NULL),
        (6, '维也纳酒店', '欢迎您入住', '南京市栖霞区珠江路268号', 'XiDan', 'Four', 1829553719, 0, 5, 5, 5, 5, 5, NULL),
        (7, '凯利酒店', '欢迎您入住', '南京市栖霞区珠江路268号', 'XiDan', 'Four', 1829553719, 0, 5, 5, 5, 5, 5, NULL),
        (8, '莫泰酒店', '欢迎您入住', '南京市栖霞区珠江路268号', 'XiDan', 'Four', 1829553719, 0, 5, 5, 5, 5, 5, NULL),
        (9, '青年酒店', '欢迎您入住', '南京市栖霞区珠江路268号', 'XiDan', 'Four', 1829553719, 0, 5, 5, 5, 5, 5, NULL),
        (10, '凯悦酒店', '欢迎您入住', '南京市栖霞区珠江路268号', 'XiDan', 'Four', 1829553719, 0, 5, 5, 5, 5, 5, NULL),
        (11, '皇冠假日酒店', '欢迎您入住', '南京市栖霞区珠江路268号', 'XiDan', 'Four', 1829553719, 0, 5, 5, 5, 5, 5, NULL),
        (12, '豪生酒店', '欢迎您入住', '南京市栖霞区珠江路268号', 'XiDan', 'Four', 1829553719, 0, 5, 5, 5, 5, 5, NULL),
        (13, '法莱德酒店', '欢迎您入住', '南京市栖霞区珠江路268号', 'XiDan', 'Four', 1829553719, 0, 5, 5, 5, 5, 5, NULL),
        (14, '茂悦酒店', '欢迎您入住', '南京市栖霞区珠江路268号', 'XiDan', 'Four', 1829553719, 0, 5, 5, 5, 5, 5, NULL),
        (15, '艾美酒店', '欢迎您入住', '南京市栖霞区珠江路268号', 'XiDan', 'Four', 1829553719, 0, 5, 5, 5, 5, 5, NULL),
        (16, '索菲特酒店', '欢迎您入住', '南京市栖霞区珠江路268号', 'XiDan', 'Four', 1829553719, 0, 5, 5, 5, 5, 5, NULL);
        */
/*!40000 ALTER TABLE `Hotel`
    ENABLE KEYS */;
COMMIT;
