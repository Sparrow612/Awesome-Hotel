...
/*!40000 ALTER TABLE `Hotel`
    DISABLE KEYS */;
INSERT INTO `Hotel`
VALUES (1, '汉庭酒店', '欢迎您入住', '南京市栖霞区珠江路268号', '南大仙林地铁站', 'Four', 1829373819, 4.8, 1, 0, 5, 5, 5, 5, 5, NULL),
       (2, '如家酒店', '欢迎您入住', '南京市鼓楼区珠江路268号', '南大仙林地铁站', 'Four', 1829373819, 4.8, 2, 0, 5, 5, 5, 5, 5, NULL),
       (3, '桂圆酒店', '欢迎您入住', '南京市栖霞区珠江路268号', '南大仙林地铁站', 'Four', 1829553719, 4.8, 6, 0, 5, 5, 5, 5, 5, NULL);
